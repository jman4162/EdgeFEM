"""
VectorEM - 3D FEM Electromagnetic Simulator
...
For high-level workflows, see vectorem.designs submodule:
...
# Import everything from pyvectorem for convenience
from pyvectorem import *
